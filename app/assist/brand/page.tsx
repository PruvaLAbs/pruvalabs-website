      ...
      <section className="mx-auto w-full max-w-7xl px-6 py-8 sm:px-10">
        ...
        <div className="grid gap-6 py-10 lg:grid-cols-[1fr_auto] lg:items-end">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
              Gelen mesajlar, AI cevapları, rezervasyonlar ve bildirimler tek
              ekranda takip edilir.
            </p>
          </div>
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
            <h2 className="text-2xl font-semibold">AI cevap geçmişi</h2>
              ...
              {visibleReplies.length > 0 ? (
                visibleReplies.map((reply) => (
                  ...
                  >
                    ...
                    <p className="mt-4 text-sm text-slate-400">Müşteri</p>
                    <p className="mt-1 leading-7 text-slate-200">
                      {reply.user_message || "Müşteri mesajı kaydı yok"}
                    </p>

                    <p className="mt-4 text-sm text-slate-400">AI cevabı</p>
                    <p className="mt-1 leading-7 text-cyan-100">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <div className="mt-6 space-y-3">
              {visibleMessages.length > 0 ? (
                ...
                <p className="text-sm text-slate-400">Henüz gelen mesaj yok.</p>
              )}
            </div>
          </div>
