        ...
        <div className="rounded-[2rem] border border-sky-100 bg-sky-50/70 p-7 sm:p-10">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <article
                key={title}
                className="pruvai-card rounded-2xl border border-sky-100 bg-white p-5"
              >
        ...
        <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {integrationSteps.map((step, index) => (
              <article
                key={step.title}
                className="pruvai-card rounded-[1.75rem] border border-slate-200 bg-white p-7 shadow-sm shadow-slate-200/50"
              >
