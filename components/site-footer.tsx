  ...
  return (
    <footer className="border-t border-slate-200 bg-white">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-5 px-6 py-8 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between sm:px-10">
        <div>
          <p className="font-semibold text-slate-700">PruvaLabs · PruvAI</p>
          <p className="mt-1">© 2025 PruvaLabs. Tüm hakları saklıdır.</p>
        </div>

        <div className="flex flex-wrap gap-5">
          <Link href="/pruvai" className="hover:text-slate-950">
            PruvAI
          </Link>
