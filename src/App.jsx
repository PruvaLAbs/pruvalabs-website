...
const translations = {
  tr: {
    ...
    products: [
      ['Harbor Puzzle', 'Mobil Oyun / Puzzle', 'Limanlar, konteynerler ve deniz rotalarından ilham alan stratejik blok bulmaca deneyimi. Offline oynanış, tema sistemi, seviye ilerleyişi ve mobil odaklı sade bulmaca yapısıyla geliştirildi.', ['Flutter', 'Puzzle', 'Offline', 'Android', 'iOS']],
      ['Word Hunt Journey', 'Mobil Oyun / Kelime Bulmaca', 'Çok dilli kelime bulmaca deneyimi. Harf birleştirme, kelime keşfi, ipucu sistemi, ödüller ve seviye ilerleyişiyle Android ve iOS için geliştirildi.', ['Flutter', 'Word Puzzle', 'Çok Dilli', 'Android', 'iOS']],
    ...
    cases: [
      ['Harbor Puzzle', 'Liman temalı stratejik blok bulmaca deneyimi, offline oynanış, tema sistemi ve mobil seviye ilerleyişi.'],
      ['Word Hunt Journey', 'Çok dilli kelime bulmaca yapısı, harf birleştirme sistemi, ipuçları ve ödüllü seviye ilerleyişi.'],
